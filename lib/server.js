...
import { getProducts, createProduct, deleteProduct, updateProduct } from './handlers/products.handler.mjs';
...
expressServer.get('/products', async (req, res) => {
  ...
  res.json({ status: true, message: "All products successfully fetched", data:result});
...
expressServer.post('/products', async (req, res) => {
  ...
  res.json({ status: true, message: "Product successfully fetched", data:result});
...
expressServer.delete('/products', async (req, res) => {
  ...
  res.json({ status: true, message: "Product successfully deleted", data:result});
...
expressServer.put('/products', async (req, res) => {
  ...
  res.json({ status: true, message: "Product successfully updated", data:result});
